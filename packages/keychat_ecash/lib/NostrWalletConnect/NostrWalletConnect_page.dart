    ...
    return Scaffold(
      ...
      body: Column(
        children: <Widget>[
          ...
          Obx(
            () => controller.nwcUri.isNotEmpty && controller.featureStatus.value
                ? Column(
                        ...
                        SettingsSection(
                          tiles: [
                            ...
                            SettingsTile(
                              ...
                              onPressed: (context) async {
                                controller.stopNwc();
                                await controller.initNostrConnectWallet(
                                  loadFromCache: false,
                                );
